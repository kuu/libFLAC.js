...
(function () {
  ...
  /** Possible return values for the Encoder.init*() functions.
   */

	Encoder.INIT_STATUS_OK = 0;
	/**< Initialization was successful. */

	Encoder.INIT_STATUS_ENCODER_ERROR = 1;
	/**< General failure to set up encoder; call FLAC__stream_encoder_get_state() for cause. */

	Encoder.INIT_STATUS_UNSUPPORTED_CONTAINER = 2;
	/**< The library was not compiled with support for the given container
	 * format.
	 */

	Encoder.INIT_STATUS_INVALID_CALLBACKS = 3;
	/**< A required callback was not supplied. */

	Encoder.INIT_STATUS_INVALID_NUMBER_OF_CHANNELS = 4;
	/**< The encoder has an invalid setting for number of channels. */

	Encoder.INIT_STATUS_INVALID_BITS_PER_SAMPLE = 5;
	/**< The encoder has an invalid setting for bits-per-sample.
	 * FLAC supports 4-32 bps but the reference encoder currently supports
	 * only up to 24 bps.
	 */

	Encoder.INIT_STATUS_INVALID_SAMPLE_RATE = 6;
	/**< The encoder has an invalid setting for the input sample rate. */

	Encoder.INIT_STATUS_INVALID_BLOCK_SIZE = 7;
	/**< The encoder has an invalid setting for the block size. */

	Encoder.INIT_STATUS_INVALID_MAX_LPC_ORDER = 8;
	/**< The encoder has an invalid setting for the maximum LPC order. */

	Encoder.INIT_STATUS_INVALID_QLP_COEFF_PRECISION = 9;
	/**< The encoder has an invalid setting for the precision of the quantized linear predictor coefficients. */

	Encoder.INIT_STATUS_BLOCK_SIZE_TOO_SMALL_FOR_LPC_ORDER = 10;
	/**< The specified block size is less than the maximum LPC order. */

	Encoder.INIT_STATUS_NOT_STREAMABLE = 11;
	/**< The encoder is bound to the <A HREF="../format.html#subset">Subset</A> but other settings violate it. */

	Encoder.INIT_STATUS_INVALID_METADATA = 12;
	...
	Encoder.INIT_STATUS_ALREADY_INITIALIZED = 13;
   ...
   */
	...
	Encoder.READ_STATUS_CONTINUE = 0;
	/**< The read was OK and decoding can continue. */

	Encoder.READ_STATUS_END_OF_STREAM = 1;
	/**< The read was attempted at the end of the stream. */

	Encoder.READ_STATUS_ABORT = 2;
	/**< An unrecoverable error occurred. */

	Encoder.READ_STATUS_UNSUPPORTED = 3;
   ...
   */
	...
	Encoder.WRITE_STATUS_OK = 0;
	/**< The write was OK and encoding can continue. */

	Encoder.WRITE_STATUS_FATAL_ERROR = 1;
   ...
   */
	...
	Encoder.SEEK_STATUS_OK = 0;
	/**< The seek was OK and encoding can continue. */

	Encoder.SEEK_STATUS_ERROR = 1;
	/**< An unrecoverable error occurred. */

	Encoder.SEEK_STATUS_UNSUPPORTED = 2;
   ...
   */
	...
	Encoder.TELL_STATUS_OK = 0;
	/**< The tell was OK and encoding can continue. */

	Encoder.TELL_STATUS_ERROR = 1;
	/**< An unrecoverable error occurred. */

	Encoder.TELL_STATUS_UNSUPPORTED = 2;
	/**< Client does not support seeking. */
   ...
   */
  _proto.getStreamableSubset = function () {
  };
   ...
   */
  _proto.getBitsPerSample = function () {
  };
   ...
   */
  _proto.getDoMidSideStereo = function () {
  };
   ...
   */
  _proto.getLooseMidSideStereo = function () {
  };
   ...
   */
  _proto.getMaxLpcOrder = function () {
  };
   ...
   */
  _proto.get_qlp_coeff_precision = function () {};
   ...
   */
  _proto.get_do_qlp_coeff_prec_search = function () {};
   ...
   */
  _proto.get_do_escape_coding = function () {};
   ...
   */
  _proto.get_do_exhaustive_model_search = function () {};
   ...
   */
  _proto.get_min_residual_partition_order = function () {};
   ...
   */
  _proto.get_max_residual_partition_order = function () {};
   ...
   */
  _proto.get_rice_parameter_search_dist = function () {};
   ...
   */
  _proto.get_total_samples_estimate = function () {};
   ...
   */
  _proto.initStream = function (writeCallback, seekCallback, tellCallback, metadataCallback, clientData) {
  };
   ...
   *    see FLAC__StreamEncoderInitStatus for the meanings of other return values.
   */
  _proto.initOggStream = function (readCallback, writeCallback, seekCallback, tellCallback, metadataCallback, clientData) {
  };
   ...
   *    see FLAC__StreamEncoderInitStatus for the meanings of other return values.
   */
  _proto.initFILE = function (file, progressCallback, clientData) {
  };
   ...
   *    see FLAC__StreamEncoderInitStatus for the meanings of other return values.
   */
  _proto.initOggFILE = function (file, progressCallback, clientData) {
  };
   ...
   *    see FLAC__StreamEncoderInitStatus for the meanings of other return values.
   */
  _proto.initFile = function (filename, progressCallback, clientData) {
  };
   ...
   *    see FLAC__StreamEncoderInitStatus for the meanings of other return values.
   */
  _proto.initOggFile = function (filename, progressCallback, clientData) {
  };
   ...
   *    went wrong.
   */
  _proto.process = function (buffer, samples) {
  };
